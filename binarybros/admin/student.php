...
<html lang = "eng">
	...
	<body style="background-image: radial-gradient(blue,red);">
		<nav class = "navbar navbar-inverse navbar-fixed-top">
			<div class = "container-fluid">
				<div class = "navbar-header">
					
					<p class = "navbar-text pull-right"><center><h4 style="color: white;">Welcome To Attendance Record System</h4></center></p>
				</div>
		...
		<div class = "container-fluid" style = "margin-top:70px;">
			<ul class = "nav nav-pills">
				<li style="color: yellow;"><a href = "home.php"><span class = "glyphicon glyphicon-home"></span> Home</a></li>
				...
				<div class = "modal-dialog" role = "document">
					<div class = "modal-content panel-primary">
						<div class = "modal-header panel-heading">
							...
							<h4 class = "modal-title" id = "myModallabel" style="color: white;">Add new Student</h4>
						</div>
			...
			<div class = "well col-lg-12">
				...
				<table id = "table" class = "table table-bordered">
					...
					<tbody>
						<?php
							$q_student = $conn->query("SELECT * FROM `student`") or die(mysqli_error($conn));
						...
						<tr>
							...
							<td><?php echo $f_student['email']?></td>
